package com.week02.sources;

import com.chapter01.fundaments.sources.*;
...
public class Evaluate {
    public static void main(String[] args) {
        com.chapter01.fundaments.sources.Stack<String> ops  = new com.chapter01.fundaments.sources.Stack<String>();
        com.chapter01.fundaments.sources.Stack<Double> vals = new com.chapter01.fundaments.sources.Stack<Double>();
