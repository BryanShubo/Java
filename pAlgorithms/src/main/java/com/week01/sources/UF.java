 ...
 *  2. void union(int p, int q): add connection between p and q
 *  3. boolean connected(int p, int q): are p and q in the same component?
 *  4. int find(int p): returns the component identifier for p (0 to N-1)
 *  5. int count(): returns the total number of components.
 */
...
public class UF {
     ...
     * (between 0 to N-1) from standard input, where each integer
