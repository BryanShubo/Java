...
*
    ...
    public DijkstraSP(edu.princeton.cs.algs4.EdgeWeightedDigraph G, int s) {
        for (edu.princeton.cs.algs4.DirectedEdge e : G.edges()) {
            if (e.weight() < 0)
        ...
        pq = new edu.princeton.cs.algs4.IndexMinPQ<Double>(G.V());
    ...
    public static void main(String[] args) {
        ...
        for (int t = 0; t < G.V(); t++) {
            if (sp.hasPathTo(t)) {
                ...
                if (sp.hasPathTo(t)) {
                    for (edu.princeton.cs.algs4.DirectedEdge e : sp.pathTo(t)) {
                        StdOut.print(e + "   ");
                    }
                }
                StdOut.println();
